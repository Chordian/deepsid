 ...
 * DeepSID
 *
 * Build URL's for SOASC, then request through http://se2a1.bigbox.info. The
 ...
 * 
 * Request goes to http://se2a1.bigbox.info/dl.php?d=/soasc/.../&url=1 which
 * then returns the full URL to a SOASC mirror site.
 * 
 * Mirrors for testing:
 * 
 * http://se2a1.bigbox.info:40000/files/index.php
...
function RequestURL($path) {
	...
	curl_setopt($ch, CURLOPT_URL, 'http://se2a1.bigbox.info/dl.php?d=/soasc/'.$path.'&url=1');
