...
var fetchSamples = function(e) 	// only used for ScriptProcessorNode based impls^
{
	...
	if (player) player._genSamples(e);
};
...
//////////// public API ////////////
	...
	*/
	...
	{
		// this API is used to make a song play faster/slower. note: the UI may use this repeatedly with 
		// different speeds during the playback of a song, i.e. the sampleRate then isn't constant - breaking
		// any calculations that are based on the incorrect assumption of a constant speed (see getPlaytime()).
	...
	*/
	...
	seekPosition(ms)
	{
		// update to account for the manually set position
		this._currentPlaytime = this._sampleRate * ms / 1000;
	}
...
//////////// song "position seeking" functionality (using standard functions) ////////////
	...
	seekPlaybackPosition(ms)
	{
		...
		this._transformer.seekPosition(ms);
	}
...
//////////// playback related ////////////
		_genSamples: function(e)
		{
			this._backendAdapter._transformer.genSamples(e);
...
//////////// Optional: "scope/trace" output ////////////
		...
		*/
		...
		/*
		* Keeps track of WebAudio's double buffering (usecase: webSID register access)
		*/
		getTickToggle: function() {
			return this._tickToggle ^ 1;
		},
